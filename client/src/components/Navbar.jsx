      ...
      >
        <nav className="flex items-center justify-between nike-container">
          ...
          <button
            ...
            className="border-outline p-2 rounded-full text-white bg-slate-400 outline-none hover:scale-110 active:scale-95 transition-all duration-300 relative text-xs "
          >
            🔚 logout
          </button>
        </nav>
